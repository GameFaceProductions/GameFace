...
public class PostComments {
    ...
    @ManyToOne
    @JsonIgnoreProperties({"gamerTag", "region", "blocked", "email", "createdAt", "role", "userFriends", "friendsList", "likes", "gameMedia", "posts", "games", "platforms", "backdrop_url", "postComments"})
    private User author;
